...
downloadOracle () {
  ...
  local URL_1="https://github.com/luvres/files/blob/master/linuxamd64_12102_database_1of2"
  local ora_partial_1=( 
    ${ORA_1}a
    ${ORA_1}b
    ${ORA_1}c
  ...
  local URL_2="https://github.com/luvres/files/blob/master/linuxamd64_12102_database_2of2"
  local ora_partial_2=( 
    ${ORA_2}a
    ${ORA_2}b
    ${ORA_2}c
